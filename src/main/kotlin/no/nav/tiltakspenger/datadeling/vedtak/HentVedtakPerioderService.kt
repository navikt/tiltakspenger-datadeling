...
/**
 * Henter vedtaksperiodene for en person, slått sammen fra vår egen base og Arena.
 * Serverer `POST /vedtak/perioder`.
 */
class HentVedtakPerioderService(
     ...
     */
    suspend fun hentVedtakPerioder(
        fnr: Fnr,
        periode: Periode,
