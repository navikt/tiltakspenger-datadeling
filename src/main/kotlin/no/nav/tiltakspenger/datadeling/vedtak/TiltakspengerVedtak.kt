 ...
 * - Eksempel 1: Søknadsvedtak med innvilgelse fra 1. januar til 31. mars (virkningsperiode = innvilgelsesperiode).
 *   Dersom man omgjør dette vedtaket, vil den nye virkningsperioden _minimum_ være det samme som vedtaket man omgjør sin virkningsperiode, i dette tilfellet 1. januar til 31. mars.
 *   Innvilgelsperioden(e) kan derimot være kortere, f.eks. hele januar og hele mars.
 *   Da vil februar implisitt ikke lenger gi rett, og en potensiell feilutbetaling kan oppstå.
 * - Eksempel 2: Søknadsvedtak innvilges fra 3. januar til 28 januar.
 *   Vedtaket omgjøre og utvides til 1. til 31. januar.
 *   Virkningsperioden vil da være lik innvilgelsesperioden (1. til 31. januar).
 * - Eksempel 3: Søknadsvedtak innvilges fra 3. januar til 31 januar.
 *   Innvilgelsesperioden endres fra 1. til 28 januar.
 *   Virkningsperioden vil da være 1. til 31. januar.
 *   29., 30. og 31. januar vil implisitt ikke lenger gi rett.
 * - Eksempel 4: Søknadsvedtak innvilges fra 1. januar til 28 januar.
 *   Innvilgelsesperioden endres fra 3. til 31 januar.
 *   Virkningsperioden vil da være 1. til 31. januar.
 *   1. og 2. januar vil implisitt ikke lenger gi rett.
 * @param virkningsperiode Perioden vedtaket gjelder for (på tidspunktet det ble iverksatt).
 * Ved søknadsbehandling/forlengelse/omgjøring vil den inneholde en eller flere innvilgelsesperioder.
 * Alle vedtakstypene vil kun ha ett resultat, bortsett fra omgjøring som kan ha et kombinasjonsresultat av innvilgelse og opphør, hvor sistnevnte er implisitt.
 * @param innvilgelsesperiode null for avlag/stans/opphør.
 * Vi har denne perioden i tillegg til virkningsperiode/vedtaksperiode for å støtte vedtak med kombinasjonsresultat; dvs. både innvilgelse og opphør i samme vedtaket.
 * Dette vil skje i omgjøringsvedtak der innvilgelsesperioden er mindre enn virkningsperiode/vedtaksperioden, da vil den resterende perioden implisitt være opphørt.
 */
data class TiltakspengerVedtak(
    ...
    /**
     * Reservert tidslinje-funksjonen.
     * Bruk [virkningsperiode] eller [innvilgelsesperiode] istedenfor.
     */
    ...
    /**
     * Tenkt brukt for å krympe vedtaket basert på tidslinja.
     * Gir ikke mening og kalles for Avslag.
