...
/**
 * Henter vedtakstidslinjen for en person: gjeldende tidslinje, alle vedtak bak den, og vedtakene fra Arena.
 * Serverer `POST /vedtak/tidslinje`.
 */
class HentVedtakTidslinjeService(
    ...
    suspend fun hentVedtakTidslinje(
        fnr: Fnr,
        periode: Periode,
