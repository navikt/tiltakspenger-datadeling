    ...
    return TiltakspengerBehandling(
        ...
        behandlingStatus = when (this.behandlingStatus) {
            ...
            DatadelingBehandlingDTO.Behandlingsstatus.UNDER_BEHANDLING -> TiltakspengerBehandling.Behandlingsstatus.UNDER_BEHANDLING
                ...
                json = ErrorJson(
                    melding = "Ukjent behandlingStatus: '${this.behandlingStatus}'." +
                        "Lovlige verdier: KLAR_TIL_BEHANDLING, INNVILGET, UNDER_BESLUTNING, KLAR_TIL_BESLUTNING",
                    kode = "ukjent_behandlingStatus",
                ),
        ...
        mottattTidspunktDatadeling = LocalDateTime.now(),
