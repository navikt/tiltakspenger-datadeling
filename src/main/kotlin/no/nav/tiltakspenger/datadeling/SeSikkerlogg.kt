 ...
 */
// TODO: På sikt skal service-laget i hovedsak stå for loggingen, og da bør sikkerlogg deles i
//  interface (domene) + impl (infra), slik at implementasjonen kan gjenbruke
//  [no.nav.tiltakspenger.datadeling.infra.Configuration.applicationProfile]. Inntil videre
//  dupliserer vi miljøvalget derfra her (NAIS_CLUSTER_NAME fra env eller system-property,
//  der "prod-gcp" betyr prod), siden domenepakka ikke kan importere infra (jf. konsist-testene).
