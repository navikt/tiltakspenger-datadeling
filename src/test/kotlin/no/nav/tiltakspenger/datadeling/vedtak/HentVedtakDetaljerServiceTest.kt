...
class HentVedtakDetaljerServiceTest {
    ...
    @Test
    fun `hentVedtakDetaljer - enkelt innvilget vedtak`() {
        runBlocking {
            ...
            val result = vedtakService.hentVedtakDetaljer(fnr, periode2022)
            result shouldContainExactlyInAnyOrder expectedVedtakFraVedtak
        }
    }

    @Test
    fun `hentVedtakDetaljer - to innvilgelser med hull`() {
        runBlocking {
            val expectedVedtakFraVedtak = listOf(
                TiltakspengeVedtakMedSak(
                    vedtak = TiltakspengerVedtak(
    ...
    @Test
    fun `hentVedtakDetaljer - innvilgelse til stans`() {
        runBlocking {
    ...
    @Test
    fun `hentVedtakDetaljer - stanser alle dager`() {
        runBlocking {
            val vedtaksliste = listOf(
                TiltakspengeVedtakMedSak(
                    vedtak = TiltakspengerVedtak(
    ...
    @Test
    fun `hentVedtakDetaljer - opphører midt i perioden`() {
        runBlocking {
            val vedtaksliste = listOf(
                TiltakspengeVedtakMedSak(
                    vedtak = TiltakspengerVedtak(
    ...
    @Test
    fun `hentVedtakDetaljer - avslag - returnerer tom liste`() {
        runBlocking {
            val expectedVedtakFraVedtak = listOf(
                TiltakspengeVedtakMedSak(
                    vedtak = TiltakspengerVedtak(
    ...
    @Test
    fun `hentVedtakDetaljer - enkelt innvilget vedtak og avslag - avslag filtreres bort`() {
        runBlocking {
