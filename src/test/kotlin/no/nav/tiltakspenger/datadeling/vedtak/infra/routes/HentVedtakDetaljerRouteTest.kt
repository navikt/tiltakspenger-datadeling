...
class HentVedtakDetaljerRouteTest {
    ...
    fun `et vedtak med tiltakspenger`() {
        with(TestApplicationContext()) {
            ...
            val vedtakService = mockk<HentVedtakDetaljerService>(relaxed = true)
            val virkningsperiode = Periode(LocalDate.of(2020, 1, 1), LocalDate.of(2024, 12, 31))
            coEvery { vedtakService.hentVedtakDetaljer(any(), any()) } returns listOf(
                ...
                application {
                    ...
                    routing {
                        authenticate(IdentityProvider.AZUREAD.value) {
                            hentVedtakDetaljerRoute(
                                hentVedtakDetaljerService = vedtakService,
                                clock = fixedClock,
                            )
                        }
                    }
