            ...
            filters {
                includes {
                    ...
                    classes(
                        ...
                        "no.nav.tiltakspenger.datadeling.vedtak.infra.routes.VedtakReqDTO",
                        "no.nav.tiltakspenger.datadeling.vedtak.infra.routes.VedtakRequest",
                        "no.nav.tiltakspenger.datadeling.vedtak.infra.routes.MappingError",
